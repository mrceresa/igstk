...
void UltrasoundProbeObjectRepresentation::CreateActors()
{
  ...
  tipMapper->SetInputConnection(surface->GetOutputPort());
  ...
  tipBlackMapper->SetInputConnection(surfaceBlack->GetOutputPort());
  ...
  handleMapper->SetInputConnection(surfaceHandle->GetOutputPort());
