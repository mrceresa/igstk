...
::CreateActors()
{
  ...
  lineMapperX->SetInputConnection( m_LineSourceX->GetOutputPort() );
  ...
  lineMapperY->SetInputConnection( m_LineSourceY->GetOutputPort() );
  ...
  lineMapperZ->SetInputConnection( m_LineSourceZ->GetOutputPort() );
